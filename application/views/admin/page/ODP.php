...
<body class="theme-red">
    ...
    <ol class="breadcrumb breadcrumb-bg-teal align-right" style="margin-top:70px;margin-bottom:-90px;background-color:#f1f1f1 !important">
          <li><a style="color:#444" href="<?php echo base_url() ?>covid19/Beranda"><i class="material-icons">home</i> Beranda</a></li>
           <li><a style="color:#999;font-weight: 350">  Data Terkonfirmasi ODP</a></li>
      </ol>
                    ...
                    <div class="card">
                        <div class="header" style="margin-bottom:-30px">
                            <h2 style="font-size: 25px;margin-top: 8px; color: black;border-left: 5px solid #1a468f; padding-left: 5px;font-size:25px;margin-left:10px;font-family:andalus;text-transform: capitalize;">
                                Data Terkonfirmasi ODP
                            </h2>
                        </div>
                        <div class="body" >

                                <a style="margin-bottom:-50px;margin-left: 30px;width:150px" href="#tambahODP" class="btn btn-default waves-effect m-b-15" type="button" data-toggle="modal" ><b><i class="material-icons"  >add</i>TAMBAH</b></a>
                                ...
                                $tgl = date('Y-m-d');
                                try{       
                                   $stmt = $conn->prepare("SELECT tgl,ODP,kdKasus FROM `tb_kasus` where tgl <= :tgl  ORDER BY `tb_kasus`.`tgl` DESC");
                                   ...
                                   foreach ($stmt as $data) {                       
                                     ?>
                                        ...
                                        <tr class="row100 body">
                                            ...
                                            <td style="width:30%;font-size:15px"><?php echo (!empty($data['ODP'])) ?  '<b>'.$data['ODP'].'</p>' : '<p style="color:red">0</p>' ?></td>
                                            <td style="width:15%;font-size:15px;text-align: center;"> 
                                              <a style="margin:0px;padding:3px 10px" href="#ubahODP<?php echo $data['kdKasus'] ?>" class="btn bg-blue waves-effect m-b-15" ><i class="material-icons" >list</i>DETAIL</a>
                                            </td>
                                            

                                            <td style="width:20%;text-align:center">
                                            <a style="margin:0px;padding:3px 10px" href="#ubahODP<?php echo $data['kdKasus'] ?>" class="btn bg-orange waves-effect m-b-15" type="button"  data-id="<?php echo $data['kdKasus'] ?>" data-toggle="modal" ><i class="material-icons" >edit</i>EDIT</a>
                                            </td>
                                        </tr>
                                        <!-- modal Ubah data ODP-->
                                        <div class="modal fade" id="ubahODP<?php echo $data['kdKasus'] ?>" tabindex="-1" role="dialog">
                                          <div class="modal-dialog modal-lg" role="document">
                                              <div class="modal-content">
                                                  <div class="modal-header">
                                                      <h4 class="modal-title" id="defaultModalLabel">Ubah Data Konfirmasi ODP Tanggal <?php echo date('d-m-Y') ?> <p class="nama"></p></h4>
                                                  </div>
                                                  <div class="modal-body clearfix">
                                                  <form id="" method="POST"  action="<?php echo base_url()?>covid19/ubahODP" enctype="multipart/form-data" class="m-l-20" >
                                                    ...
                                                    <input class="hidden" type="hidden" name="tanggal" value="<?php echo $data['tgl'] ?>" >
                                                      ...
                                                      <div class="row m-t-40" >
                                                        ...
                                                        <div class="col-md-6" >
                                                        <div class="form-group " style="width:96%; margin-left:2px; margin-bottom:30px"  >
                                                            <label for="alamat" class="text-black">Konfirmasi ODP<span class="text-danger">*</span></label> 
                                                            <div class="form-line">
                                                              <input onkeypress="return hanyaAngka(event)" class="form-control" type="number" name="ODP" placeholder="Konfirmasi ODP" <?php echo 'value="'.$data['ODP'].'"'  ?> required>
                                      ...
                                      <!--end modal Ubah data ODP -->
                                        <!-- modal hapus data ODP 
                                        <div class="modal fade" id="hapusODP<?php echo $data['kdKasus'] ?>" tabindex="-1" role="dialog">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <a href="<?php echo base_url("ODP/hapusPengumuman?kd=".$data['kdKasus'])?> " type="submit" style="float:right" class="btn btn-primary waves-effect m-t-15 m-r-20" name="hapus">HAPUS</a>
                                                        <button type="button" style="float:left" class="btn btn-danger waves-effect  m-t-15 m-l-20" data-dismiss="modal">BATAL</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <!--end modal hapus data ODP-->                                 
                                    <?php
                                    $i++;
                                  }}
                             ...
                             $data_tanggal = array();
                                  $data_total = array();
                                   $stmt = $conn->prepare("SELECT tgl,ODP,kdKasus FROM `tb_kasus` where tgl <= :tgl ");
                                   $stmt->execute(['tgl'=>$tgl]);

                                   foreach ($stmt as $data) {    
                                   $data_tanggal[] = date('d-m-Y', strtotime($data['tgl'])); // Memasukan tanggal ke dalam array
                                   $data_total[] = $data['ODP']; // Memasukan total ke dalam array    
                                   echo $data_tanggal[1];
                                  echo $data_total[1];
                                 }
                             } catch(PDOException $e){
                             ...
                             ?>
                                 ...
                                 <!-- modal tambah akun ODP -->
                                        <div class="modal fade" id="tambahODP" tabindex="-1" role="dialog">
                                          <div class="modal-dialog modal-lg" role="document">
                                              <div class="modal-content">
                                                  <div class="modal-header">
                                                  ...
                                                  <div class="modal-body clearfix">
                                                   <form id="validation" method="POST"  action="<?php echo base_url()?>covid19/tambahODP" enctype="multipart/form-data" class="m-l-20" >
                                                      <div class="row m-t-40" >
                                                        <div class="col-md-6" >
                                                          <div class="form-group " style="width:96%; margin-left:2px; margin-bottom:30px"  >
                                                            <label for="alamat" class="text-black">Tanggal<span class="text-danger">*</span></label> 
                                                        ...
                                                        <div class="form-group " style="width:96%; margin-left:2px; margin-bottom:30px"  >
                                                            <label for="alamat" class="text-black">Konfirmasi ODP<span class="text-danger">*</span></label> 
                                                            <div class="form-line">
                                                              <input onkeypress="return hanyaAngka1(event)" class="form-control" type="number" name="ODP" placeholder="Konfirmasi ODP" required>
       ...
       if (charCode > 31 && (charCode < 48 || charCode > 57))
        ...
        var chart = new Chart(linechart, {
          ...
          data: {
            ...
            datasets: [{
              label: 'Terkonfirmasi ODP',
              data: <?php echo json_encode($data_total) ?>,
              borderColor: 'rgba(31, 164, 173, 0.75)',
                        backgroundColor: 'rgba(31, 164, 173, 0.3)',
                        pointBorderColor: 'rgba(31, 164, 173, 0)',
                        pointBackgroundColor: 'rgba(31, 164, 173, 0.9)',
              borderWidth: 2
