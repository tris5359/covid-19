...
<body class="theme-red">
    ...
    <ol class="breadcrumb breadcrumb-bg-teal align-right" style="margin-top:70px;margin-bottom:-90px;background-color:#f1f1f1 !important">
          <li><a style="color:#444" href="<?php echo base_url() ?>covid19/Beranda"><i class="material-icons">home</i> Beranda</a></li>
           <li><a style="color:#999;font-weight: 350">  Data Terkonfirmasi sembuh</a></li>
      </ol>
                    ...
                    <div class="card">
                        <div class="header" style="margin-bottom:-30px">
                            <h2 style="font-size: 25px;margin-top: 8px; color: black;border-left: 5px solid #1a468f; padding-left: 5px;font-size:25px;margin-left:10px;font-family:andalus;text-transform: capitalize;">
                                Data Terkonfirmasi sembuh
                            </h2>
                        </div>
                        <div class="body" >

                                <a style="margin-bottom:-50px;margin-left: 30px;width:150px" href="#tambahsembuh" class="btn btn-default waves-effect m-b-15" type="button" data-toggle="modal" ><b><i class="material-icons"  >add</i>TAMBAH</b></a>
                                ...
                                $tgl = date('Y-m-d');
                                try{       
                                   $stmt = $conn->prepare("SELECT tgl,sembuh,kdKasus FROM `tb_kasus` where tgl <= :tgl  ORDER BY `tb_kasus`.`tgl` DESC");
                                   ...
                                   foreach ($stmt as $data) {                       
                                     ?>
                                        ...
                                        <tr class="row100 body">
                                            ...
                                            <td style="width:30%;font-size:15px"><?php echo (!empty($data['sembuh'])) ?  '<b>'.$data['sembuh'].'</p>' : '<p style="color:red">0</p>' ?></td>
                                            <td style="width:15%;font-size:15px;text-align: center;"> 
                                              <a style="margin:0px;padding:3px 10px" href="#ubahsembuh<?php echo $data['kdKasus'] ?>" class="btn bg-blue waves-effect m-b-15" ><i class="material-icons" >list</i>DETAIL</a>
                                            </td>
                                            

                                            <td style="width:20%;text-align:center">
                                            <a style="margin:0px;padding:3px 10px" href="#ubahsembuh<?php echo $data['kdKasus'] ?>" class="btn bg-orange waves-effect m-b-15" type="button"  data-id="<?php echo $data['kdKasus'] ?>" data-toggle="modal" ><i class="material-icons" >edit</i>EDIT</a>
                                            </td>
                                        </tr>
                                        <!-- modal Ubah data sembuh-->
                                        <div class="modal fade" id="ubahsembuh<?php echo $data['kdKasus'] ?>" tabindex="-1" role="dialog">
                                          <div class="modal-dialog modal-lg" role="document">
                                              <div class="modal-content">
                                                  <div class="modal-header">
                                                      <h4 class="modal-title" id="defaultModalLabel">Ubah Data Konfirmasi Sembuh Tanggal <?php echo date('d-m-Y') ?> <p class="nama"></p></h4>
                                                  </div>
                                                  <div class="modal-body clearfix">
                                                  <form id="" method="POST"  action="<?php echo base_url()?>covid19/ubahSembuh" enctype="multipart/form-data" class="m-l-20" >
                                                    ...
                                                    <input class="hidden" type="hidden" name="tanggal" value="<?php echo $data['tgl'] ?>" >
                                                      ...
                                                      <div class="row m-t-40" >
                                                        ...
                                                        <div class="col-md-6" >
                                                        <div class="form-group " style="width:96%; margin-left:2px; margin-bottom:30px"  >
                                                            <label for="alamat" class="text-black">Konfirmasi Sembuh<span class="text-danger">*</span></label> 
                                                            <div class="form-line">
                                                              <input onkeypress="return hanyaAngka(event)" class="form-control" type="number" name="Sembuh" placeholder="Konfirmasi Sembuh" <?php echo 'value="'.$data['sembuh'].'"'  ?> required>
                                      ...
                                      <!--end modal Ubah data sembuh -->
                                        <!-- modal hapus data sembuh 
                                        <div class="modal fade" id="hapussembuh<?php echo $data['kdKasus'] ?>" tabindex="-1" role="dialog">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <a href="<?php echo base_url("sembuh/hapusPengumuman?kd=".$data['kdKasus'])?> " type="submit" style="float:right" class="btn btn-primary waves-effect m-t-15 m-r-20" name="hapus">HAPUS</a>
                                                        <button type="button" style="float:left" class="btn btn-danger waves-effect  m-t-15 m-l-20" data-dismiss="modal">BATAL</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <!--end modal hapus data sembuh-->                                 
                                    <?php
                                    $i++;
                                  }}
                             ...
                             $data_tanggal = array();
                                  $data_total = array();
                                   $stmt = $conn->prepare("SELECT tgl,sembuh,kdKasus FROM `tb_kasus` where tgl <= :tgl ");
                                   $stmt->execute(['tgl'=>$tgl]);

                                   foreach ($stmt as $data) {    
                                   $data_tanggal[] = date('d-m-Y', strtotime($data['tgl'])); // Memasukan tanggal ke dalam array
                                   $data_total[] = $data['sembuh']; // Memasukan total ke dalam array    
                                 }
                             } catch(PDOException $e){
                             echo "There is some problem in connection: " . $e->getMessage();
                             }
                             ...
                             ?>
                                 ...
                                 <!-- modal tambah akun sembuh -->
                                        <div class="modal fade" id="tambahsembuh" tabindex="-1" role="dialog">
                                          <div class="modal-dialog modal-lg" role="document">
                                              <div class="modal-content">
                                                  <div class="modal-header">
                                                      <h4 class="modal-title" id="defaultModalLabel" style="text-transform: capitalize;">Tambah Data Konfirmasi Sembuh Tanggal <?php echo date('d-m-Y') ?><p class="nama"></p></h4>
                                                  </div>
                                                  <div class="modal-body clearfix">
                                                   <form id="validation" method="POST"  action="<?php echo base_url()?>covid19/tambahSembuh" enctype="multipart/form-data" class="m-l-20" >
                                                      <div class="row m-t-40" >
                                                        <div class="col-md-6" >
                                                          <div class="form-group " style="width:96%; margin-left:2px; margin-bottom:30px"  >
                                                            <label for="alamat" class="text-black">Tanggal<span class="text-danger">*</span></label> 
                                                        ...
                                                        <div class="form-group " style="width:96%; margin-left:2px; margin-bottom:30px"  >
                                                            <label for="alamat" class="text-black">Konfirmasi Sembuh<span class="text-danger">*</span></label> 
                                                            <div class="form-line">
                                                              <input onkeypress="return hanyaAngka1(event)" class="form-control" type="number" name="Sembuh" placeholder="Konfirmasi Sembuh" required>
        ...
        var chart = new Chart(linechart, {
          ...
          data: {
            ...
            datasets: [{
              ...
              borderColor: 'rgba(0, 189, 0, 0.75)',
                        backgroundColor: 'rgba(0, 189, 0, 0.3)',
                        pointBorderColor: 'rgba(0, 189, 0, 0)',
                        pointBackgroundColor: 'rgba(0, 189, 0, 0.9)',
              borderWidth: 2
