$(function () {
    ...
    //Masked Input ============================================================================================================================
    var $demoMaskedInput = $('.demo-masked-input1');

    // Number 3
    $demoMaskedInput.find('._3nomor').inputmask('999', { placeholder: '___' });

    // Number 4
    $demoMaskedInput.find('._4nomor').inputmask('9999', { placeholder: '____' });

    // Number 4
    $demoMaskedInput.find('._tgl').inputmask('y', { placeholder: '0000' });
    ...
    //Mobile Phone Number
    $demoMaskedInput.find('.mobile-phone-number').inputmask('+62 (999) 9999-9999', { placeholder: '+62 (___) ____-____' });
    //Phone Number
    $demoMaskedInput.find('.phone-number').inputmask('+62 (999) 9999-9999', { placeholder: '+62 (___) ____-____' });
