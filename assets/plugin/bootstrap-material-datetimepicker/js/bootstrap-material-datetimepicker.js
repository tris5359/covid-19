(function ($, moment)
{
   ...
   function Plugin(element, options)
   {
      ...
      this.params = {date: true, time: true, format: 'YYYY-MM-DD', minDate: null, maxDate: null, currentDate: null, lang: 'de', weekStart: 0, shortTime: false, clearButton: false, nowButton: false, cancelText: 'Batal', okText: 'Oke', clearText: 'Hapus', nowText: 'Now', switchOnClick: false};
   ...
   Plugin.prototype =
           {
              ...
              initTemplate: function ()
              {
                 this.template = '<div class="dtp hidden" id="' + this.name + '">' +
                         ...
                         '<button class="dtp-btn-now btn btn-default hidden waves-effect">' + this.params.nowText + '</button>' +
                         '<button class="dtp-btn-clear btn btn-default hidden waves-effect">' + this.params.clearText + '</button>' +
                         '<button class="dtp-btn-cancel btn btn-danger waves-effect">' + this.params.cancelText + '</button>' +
                         '<button class="dtp-btn-ok btn btn-primary waves-effect">' + this.params.okText + '</button>' +
                         '<div class="clearfix"></div>' +
                         '</div>' +
                         '</div>' +
                         '</div>';
